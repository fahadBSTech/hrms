...
git clone https://github.com/Bitsol-Technologies/frappe --branch "$BRANCH_TO_CLONE" --depth 1
...
bench get-app https://github.com/Bitsol-Technologies/lending --branch ${BRANCH_TO_CLONE%"-hotfix"}
